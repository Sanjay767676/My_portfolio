...
const defaultProjects: Project[] = [
  {
    id: "1",
    title: "Texperia — Event Management Platform",
    description: "A modern, end-to-end event management platform designed to streamline registrations, ticketing, and event scheduling with interactive user dashboards.",
    technologies: ["React", "TypeScript", "TailwindCSS", "Express", "Node.js", "Firebase"],
    githubUrl: "https://github.com/Sanjay767676",
    liveUrl: "#",
  },
  {
    id: "2",
    title: "ThunaivanAI — Government Scheme Explainer",
    description: "An AI-powered virtual assistant that simplifies and explains complex government welfare schemes, helping citizens identify eligibility and application processes.",
    technologies: ["React", "TypeScript", "TailwindCSS", "Gemini API", "LangChain", "Python"],
    githubUrl: "https://github.com/Sanjay767676",
    liveUrl: "#",
  },
  {
    id: "3",
    title: "AuraSafe",
    description: "A secure credentials and digital asset vault featuring end-to-end encryption, multi-factor authentication, and safe cloud backup.",
    technologies: ["React", "TypeScript", "TailwindCSS", "Node.js", "Express", "PostgreSQL", "WebCrypto API"],
    githubUrl: "https://github.com/Sanjay767676",
    liveUrl: "#",
  },
  {
    id: "4",
    title: "FlowOps",
    description: "An automated DevOps pipeline orchestration tool that visualizes workflow stages, deployments, and environment health checks.",
    technologies: ["React", "TypeScript", "Node.js", "Docker", "Kubernetes", "GitHub Actions"],
    githubUrl: "https://github.com/Sanjay767676",
    liveUrl: "#",
  },
  {
    id: "5",
    title: "AgriMithra",
    description: "A digital agriculture companion providing farmers with real-time soil health analysis, crop recommendation models, and local market price listings.",
    technologies: ["Python", "Flask", "Machine Learning", "Scikit-learn", "React"],
    githubUrl: "https://github.com/Sanjay767676",
    liveUrl: "#",
  },
  {
    id: "6",
    title: "AnnualDay",
    description: "A custom interactive media portal and event registration site built for managing institutional annual day celebrations and performance signups.",
    technologies: ["React", "TypeScript", "TailwindCSS", "Firebase", "GSAP"],
    githubUrl: "https://github.com/Sanjay767676",
    liveUrl: "#",
  },
];
